...
/**
 * Prompt for identifying potential vulnerabilities in a binary. Searches for dangerous function
 * calls and provides context for security analysis.
 */
@GhidraMcpPrompt(
...
public class FindVulnerabilitiesPrompt extends BaseMcpPrompt {
  ...
  public List<PromptArgument> getArguments() {
    return List.of(
        ...
        new PromptArgument(
            "max_functions",
            "Maximum number of suspicious functions to analyze (default 10)",
            false));
  }
  ...
  public Mono<GetPromptResult> generate(
    ...
    return Mono.fromCallable(
        () -> {
          ...
          int maxFunctions =
              Integer.parseInt(getOptionalArgument(arguments, "max_functions", "10"));
          ...
          try {
            ...
            return new GetPromptResult(
                "Security vulnerability analysis for " + programName, messages);
          } finally {
            if (decompiler != null) {
              decompiler.dispose();
            }
