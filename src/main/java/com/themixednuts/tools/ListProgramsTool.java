...
public class ListProgramsTool extends BaseMcpTool {
    ...
    /**
     * Creates a pagination cursor using the file's pathname.
     * Using pathname alone ensures cursor stability - the old format including
     * isOpen status would become invalid if a program was opened/closed between requests.
     */
