...
public class ListProgramsTool extends BaseMcpTool {
  ...
  /**
   * Creates a pagination cursor that includes all sorting criteria. Format:
   * isOpen:lastModifiedTime:name:pathname This ensures the cursor remains valid even if program
   * states change between requests.
   */
