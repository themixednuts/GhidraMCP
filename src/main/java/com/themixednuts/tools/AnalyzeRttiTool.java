...
@GhidraMcpTool(name = "Analyze RTTI", description = "Analyze Microsoft RTTI at a given address and return parsed metadata.", mcpName = "analyze_rtti", mcpDescription = """
            <use_case>
    ...
    public JsonSchema schema() {
        ...
        schemaRoot.property(ARG_FILE_NAME,
                SchemaBuilder.string(mapper)
                        .description("The name of the Ghidra program file to analyze"));
