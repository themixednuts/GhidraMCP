...
@GhidraMcpTool(key = "Add Label", category = ToolCategory.SYMBOLS, description = "Adds a new label at a specified address.", mcpName = "add_label", mcpDescription = "Creates a new symbol label at a specific address.")
