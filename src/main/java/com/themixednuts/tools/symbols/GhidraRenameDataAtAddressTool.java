...
@GhidraMcpTool(name = "Rename Data at Address", category = ToolCategory.SYMBOLS, description = "Enable the MCP tool to rename data at a specific address.", mcpName = "rename_data_at_address", mcpDescription = "Assign or change the symbolic label (name) for the data item located at the specified memory address.")
