...
public class DeleteBookmarkTool extends BaseMcpTool {
  ...
  public JsonSchema schema() {
    ...
    schemaRoot.property(
        ...
        SchemaBuilder.string(mapper)
            .description(
                "Optional: Filter bookmarks by category (e.g., 'Default', 'My Analysis')."));
    ...
    schemaRoot.requiredProperty(ARG_FILE_NAME).requiredProperty(ARG_ADDRESS);
  ...
  public Mono<? extends Object> execute(
    ...
    return getProgram(args, tool)
        .flatMap(program -> handleDeleteBookmark(program, args, annotation));
  }

  private Mono<? extends Object> handleDeleteBookmark(
                                ...
                                .suggestions(
                                    List.of(
                                        new GhidraMcpError.ErrorSuggestion(
                                            ...
                                            "Ensure the program is writable and bookmark manager is"
                                                + " available",
                                            null,
                                            null)))
                                .build();
