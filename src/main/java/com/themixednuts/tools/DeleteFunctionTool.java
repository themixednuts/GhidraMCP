...
public class DeleteFunctionTool implements IGhidraMcpSpecification {
        ...
        private Mono<? extends Object> deleteBySymbolId(Program program, Long symbolId, String toolOperation,
                        Map<String, Object> args, GhidraMcpTool annotation) {
                return Mono.fromCallable(() -> {
                        Symbol symbol = program.getSymbolTable().getSymbol(symbolId);
                        if (symbol == null) {
                                throw new GhidraMcpException(
                                                createFunctionNotFoundError(toolOperation, "symbol_id",
                                                                symbolId.toString()));
                        }
                                ...
                                .flatMap(addressResult -> {
                                        ...
                                        if (function == null) {
                                                return Mono.error(new GhidraMcpException(
                                                                createFunctionNotFoundError(toolOperation, "address",
                                                                                addressStr)));
                                        }
        ...
        private Mono<? extends Object> deleteByName(Program program, String name, String toolOperation,
                        Map<String, Object> args, GhidraMcpTool annotation) {
                return Mono.fromCallable(() -> {
