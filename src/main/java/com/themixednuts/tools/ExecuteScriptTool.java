...
@GhidraMcpTool(name = "Script Guidance Tool", description = "Provides guidance on using Ghidra scripts like DemangleAllScript for advanced demangling", mcpName = "script_guidance", mcpDescription = """
        <use_case>
...
public class ExecuteScriptTool extends BaseMcpTool {
    ...
    public static class ScriptGuidance {
        ...
        public ScriptGuidance(String scriptName, String guidanceType, String instructions, String tips,
     ...
     * @param args The tool arguments containing fileName, scriptName, and
     *             guidanceType
