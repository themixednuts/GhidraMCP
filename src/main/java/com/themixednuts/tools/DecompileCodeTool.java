...
public class DecompileCodeTool implements IGhidraMcpSpecification {
        ...
        public JsonSchema schema() {
                ...
                schemaRoot.property(ARG_TARGET_VALUE, schemaRoot.string()
                ...
                schemaRoot.property(ARG_INCLUDE_AST, schemaRoot.bool()
                                .description("Include abstract syntax tree information")
                                .defaultValue(false));

                schemaRoot.property(ARG_TIMEOUT, schemaRoot.integer()
