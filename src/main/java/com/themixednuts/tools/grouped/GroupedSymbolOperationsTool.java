...
@GhidraMcpTool(name = "Grouped Symbol Operations", category = ToolCategory.GROUPED, description = "Performs multiple related symbol operations.", mcpName = "grouped_symbol_operations", mcpDescription = "Accepts a list of symbol operations to perform as a group.")
