...
@GhidraMcpTool(name = "Grouped Function Operations", category = ToolCategory.GROUPED, description = "Performs multiple related function operations.", mcpName = "grouped_function_operations", mcpDescription = "Accepts a list of function operations (like rename, set prototype) to perform as a group.")
