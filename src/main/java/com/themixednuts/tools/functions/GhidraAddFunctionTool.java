...
@GhidraMcpTool(key = "Add Function", category = ToolCategory.FUNCTIONS, description = "Adds a new function at a specified address.", mcpName = "add_function", mcpDescription = "Adds a new function at a specified address.")
