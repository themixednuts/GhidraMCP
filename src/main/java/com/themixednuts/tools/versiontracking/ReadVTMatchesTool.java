...
public class ReadVTMatchesTool extends BaseMcpTool {
    ...
    public JsonSchema schema() {
        ...
        schemaRoot.property(ARG_STATUS, SchemaBuilder.string(mapper)
                .enumValues("AVAILABLE", "ACCEPTED", "REJECTED", "BLOCKED")
                .description("Filter by match status"));

        schemaRoot.property(ARG_MATCH_TYPE, SchemaBuilder.string(mapper)
        ...
        schemaRoot.property(ARG_CORRELATOR, SchemaBuilder.string(mapper)
                .description("Filter by correlator name"));

        schemaRoot.property(ARG_CURSOR, SchemaBuilder.string(mapper)
    ...
    private boolean matchesFilters(VTMatch match, Optional<String> statusFilter, Optional<String> typeFilter,
            Optional<Double> minSimilarity, Optional<Double> minConfidence) {
    ...
    private VTMatchInfo buildMatchInfo(VTMatch match, VTMatchSet matchSet,
            Program sourceProgram, Program destProgram) {
