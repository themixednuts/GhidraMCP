...
@GhidraMcpTool(name = "Remove Bookmark", category = ToolCategory.PROJECT_MANAGEMENT, description = "Removes a bookmark at the specified address, optionally filtering by properties.", mcpName = "remove_bookmark", mcpDescription = "Removes a bookmark at the specified address.")
