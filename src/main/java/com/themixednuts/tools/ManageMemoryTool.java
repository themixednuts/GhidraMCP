...
public class ManageMemoryTool implements IGhidraMcpSpecification {
    ...
    public JsonSchema schema() {
        ...
        schemaRoot.addConditionals(
                conditional(ARG_ACTION, ACTION_READ).require(ARG_ADDRESS, ARG_LENGTH),
                conditional(ARG_ACTION, ACTION_WRITE).require(ARG_ADDRESS, ARG_BYTES_HEX),
                conditional(ARG_ACTION, ACTION_UNDEFINE).require(ARG_ADDRESS));
