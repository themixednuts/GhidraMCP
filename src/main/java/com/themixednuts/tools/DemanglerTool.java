...
@GhidraMcpTool(name = "Demangle Symbol", description = "Demangle C++ and other mangled symbols to their human-readable form", mcpName = "demangle_symbol", mcpDescription = """
        <use_case>
...
public class DemanglerTool extends BaseMcpTool {
     ...
     * @param args The tool arguments containing fileName, mangledSymbol, and
     *             optional demanglerName
    ...
    private DemangleResult performDemangling(Program program, String mangledSymbol, Optional<String> demanglerNameOpt)
            throws GhidraMcpException {
        try {
            // Use the correct, non-deprecated method: demangle(Program, String, Address)
            // According to the API docs, this returns List<DemangledObject> of successful
            // demanglings
    ...
    /**
     * Analyzes a symbol to provide helpful information about its format and
     * potential issues.
     */
