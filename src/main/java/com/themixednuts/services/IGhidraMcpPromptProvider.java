...
/**
 * Service interface for providing MCP prompt specifications. Implementations discover and configure
 * available MCP prompts for reverse engineering workflows.
 */
