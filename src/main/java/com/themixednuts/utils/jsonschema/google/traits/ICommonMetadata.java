...
/**
 * Capability interface for common metadata fields (title, description, default).
 * All schema types support these fields according to Google AI API Schema specification.
 *
...
public interface ICommonMetadata<SELF> {
     ...
     * Per JSON Schema, this field is intended for documentation generators and doesn't affect validation.
     *
