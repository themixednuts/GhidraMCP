...
/**
 * Capability interface for format keyword.
 * Supported on String, Number, and Integer types in Google AI API.
 *
 * <p>The format field specifies the data format. While any value is allowed,
 * certain formats trigger special functionality in the Google AI API.</p>
 *
...
public interface IFormat<SELF> {
     ...
     * <p>Common formats:</p>
     * <ul>
     *   <li>String: email, uri, date-time, enum, etc.</li>
     *   <li>Number: float, double</li>
     *   <li>Integer: int32, int64</li>
     * </ul>
     *
