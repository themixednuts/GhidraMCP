...
/**
 * Abstract base class for all Google AI API schema builder implementations.
 * Provides shared implementation logic for common metadata, Google-specific
 * fields,
 * and anyOf operations.
 *
...
abstract class AbstractSchemaBuilderImpl<SELF> {
     ...
     * Subclasses must override this to return the correct type.
     */
