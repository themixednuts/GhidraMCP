...
/**
 * Represents a validation error or warning for Google AI API schema validation. Similar to
 * NetworkNT's ValidationMessage but tailored for Google schema format.
 */
public class ValidationMessage {
  ...
  private ValidationMessage(
      String path, String message, String keyword, ValidationSeverity severity) {
  ...
  public String toString() {
    return String.format(
        "%s: %s [%s] at %s", severity, message, keyword != null ? keyword : "unknown", path);
  }
}
