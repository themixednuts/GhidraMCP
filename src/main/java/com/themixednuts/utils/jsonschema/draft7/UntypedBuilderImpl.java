...
/**
 * Builder for schemas WITHOUT a base type constraint.
 * Used for pure composition schemas (oneOf, anyOf, allOf, not) where the type
 * is determined solely by the composition keywords.
 * 
 * <p>
 * Example: Union of different types
 * </p>
 * 
 * <pre>{@code
...
final class UntypedBuilderImpl implements
    ...
    @Override
    public UntypedBuilderImpl ifThenElse(IBuildableSchemaType ifSchema, IBuildableSchemaType thenSchema,
