...
/**
 * Abstract base class for all schema builder implementations. Provides shared implementation logic
 * for common keywords and composition/conditional operations.
 *
...
abstract class AbstractSchemaBuilderImpl<SELF> {
  ...
  /**
   * Returns this instance cast to the concrete builder type. Subclasses should override this to
