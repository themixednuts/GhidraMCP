...
/**
 * Capability interface for composition keywords (allOf, oneOf, not). Draft 7 allows these on any
 * schema type for combining and modifying schemas.
 *
 ...
 *
 * <ul>
 *   <li><b>allOf</b>: Schema must match ALL provided schemas (intersection/composition)
 *   <li><b>oneOf</b>: Schema must match EXACTLY ONE of the provided schemas (discriminated union)
 *   <li><b>not</b>: Schema must NOT match the provided schema (negation)
 * </ul>
 *
 * @param <SELF> The concrete builder type for method chaining
 * @see <a href=
 *     "https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.7">Draft 7
 *     Composition</a>
 */
public interface IComposition<SELF> {
  ...
  /**
   * Adds oneOf constraint - schema must validate against EXACTLY ONE of the provided schemas.
   *
