 ...
 * All schema types support anyOf - the schema must validate against ANY (one
 * or more) of the provided schemas.
 *
 * <p>
 ...
 * @see <a href=
 *      "https://json-schema.org/draft-07/json-schema-validation.html#rfc.section.6.7.3">Draft
 *      7 anyOf</a>
 */
