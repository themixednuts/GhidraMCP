 ...
 *
 * <p>This builder implements the JSON Schema Draft 7 specification without OpenAPI extensions. It
 * supports conditionals (if/then/else) but does NOT support OpenAPI-specific features like
 ...
 * }</pre>
 *
 * @see <a href= "https://json-schema.org/draft-07/json-schema-validation.html">JSON Schema Draft
 *     7</a>
 */
public class SchemaBuilder {
  ...
  /**
   * Object schema builder for JSON Schema Draft 7. Includes all Draft 7 features: if/then/else
   * conditionals, allOf, oneOf, not, and additionalProperties.
   */
  ...
  /**
   * Alias for object(ObjectMapper) - creates an object schema builder for Draft 7. This is just a
   * semantic alias to emphasize Draft 7 compliance.
   */
  ...
  /**
   * Creates a schema with ONLY oneOf constraint and NO base type. Use this for union types where
   * data can be one of several different types.
   *
   ...
   * data can match one or more of several types.
   *
  ...
  /**
   * Creates a schema with ONLY allOf constraint and NO base type. Use this for intersection types
   * where data must match all schemas.
   *
  ...
  /**
   * Creates a schema with ONLY not constraint and NO base type. Use this to exclude a specific
   * schema pattern.
   *
