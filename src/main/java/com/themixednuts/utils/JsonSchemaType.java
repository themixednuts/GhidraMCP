...
/**
 * Represents the valid data types for a JSON Schema according to the OpenAPI
 * 3.0.3 specification,
...
public enum JsonSchemaType {
	...
	/**
	 * Returns the string representation of the schema type as expected in the JSON
	 * schema.
	 * 
