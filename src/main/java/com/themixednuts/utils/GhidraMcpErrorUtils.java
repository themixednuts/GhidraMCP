...
/**
 * Utility class for creating error messages.
 * Most methods just delegate to GhidraMcpError factory methods.
 */
public class GhidraMcpErrorUtils {
    ...
    public static GhidraMcpError fileNotFound(String fileName, java.util.List<String> available, String toolName) {
        String hint = available != null && !available.isEmpty()
