...
/**
 * Standardized operation result for create, update, delete operations.
...
public class OperationResult {
    ...
    public OperationResult(boolean success, String operation, String target, String message, String details) {
        this.success = success;
        this.operation = operation;
        this.target = target;
        this.message = message;
    ...
    public static OperationResult failure(String operation, String target, String message, String details) {
