...
/**
 * Comprehensive decompilation result model.
 * Used by DecompileCodeTool to return structured decompilation data.
 */
...
public class DecompilationResult {
    ...
    public DecompilationResult(String type, String targetName, String entryAddress,
                              boolean successful, String code, String error) {
        this.type = type;
