...
/**
 * Unified model representing a member (component) within a Structure or Union.
 * Consolidates StructureMemberInfo and UnionMemberInfo into a single model.
 */
...
public class ComponentMemberInfo {
	 ...
	 */
	public ComponentMemberInfo(String name, String dataTypePath, int offset, int ordinal,
	                          int length, String comment, boolean isBitField) {
		this.name = name;
