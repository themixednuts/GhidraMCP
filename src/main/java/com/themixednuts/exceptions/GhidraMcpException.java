...
public class GhidraMcpException extends RuntimeException {
	...
	private final GhidraMcpError structuredError;
	 ...
	 */
	public GhidraMcpException(GhidraMcpError structuredError) {
		super(structuredError.getMessage());
	 ...
	 *         debug data
	 */
	public GhidraMcpError getStructuredError() {
	...
	public GhidraMcpError.ErrorType getErrorType() {
		return structuredError.getErrorType();
	}
	...
	public String getErrorCode() {
		return structuredError.getErrorCode();
	}
	...
	public boolean isValidationError() {
		return structuredError.getErrorType() == GhidraMcpError.ErrorType.VALIDATION;
	}
	...
	public boolean isResourceNotFoundError() {
		return structuredError.getErrorType() == GhidraMcpError.ErrorType.RESOURCE_NOT_FOUND;
	}
	...
	public boolean isDataTypeParsingError() {
		return structuredError.getErrorType() == GhidraMcpError.ErrorType.DATA_TYPE_PARSING;
	}
	...
	public boolean isExecutionError() {
		return structuredError.getErrorType() == GhidraMcpError.ErrorType.EXECUTION;
	}
	 ...
	 */
	public static GhidraMcpException fromException(Throwable cause, String toolOperation, String toolClass) {
		GhidraMcpError error = GhidraMcpError.internal()
				...
				.context(new GhidraMcpError.ErrorContext(
						...
						null,
						null,
						java.util.Map.of("exceptionType", cause.getClass().getSimpleName())))
	...
	public String toString() {
		return "GhidraMcpException{" +
				"errorType=" + structuredError.getErrorType() +
				", errorCode='" + structuredError.getErrorCode() + '\'' +
				", message='" + getMessage() + '\'' +
				'}';
	}
}