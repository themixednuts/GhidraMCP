...
/**
 * Provides MCP completion specifications for auto-complete functionality.
 * Completions are registered for each prompt that needs them.
 * 
 * <p>Note: Unlike tools, resources, and prompts, completions are bound to specific
 * prompts/resources at construction time, so we use direct instantiation rather
 * than ServiceLoader discovery.
 */
