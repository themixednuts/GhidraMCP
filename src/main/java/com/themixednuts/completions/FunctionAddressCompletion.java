...
/**
 * Provides auto-completion for function addresses.
 * Suggests function names and their addresses based on partial input.
 */
        ...
        return Mono.fromCallable(() -> {
            ...
            return new CompleteResult(
                    new CompleteResult.CompleteCompletion(
                            suggestions,
                            suggestions.size(),
                            suggestions.size() >= MAX_COMPLETIONS
                    )
            );
        });
    }

    private void collectFunctionSuggestions(Program program, String prefix, List<String> suggestions) {
