...
@GhidraMcpResource(
    ...
    description = "Provides decompiled C code for a specific function. Specify program name and function entry address.",
        ...
        return Mono.fromCallable(() -> {
            ...
            try {
                ...
                if (results.decompileCompleted() && results.getDecompiledFunction() != null) {
                    ...
                    result.put("error", results.getErrorMessage() != null ? 
                            results.getErrorMessage() : "Decompilation failed or produced no output");
                }
                ...
                result.put("metadata", Map.of(
                    ...
                    "stackFrameSize", function.getStackFrame() != null ? 
                            function.getStackFrame().getFrameSize() : 0
                ));
