...
public class ProgramDataTypesResource extends BaseMcpResource {
        ...
        return Mono.fromCallable(() -> {
            ...
            try {
                ...
                Map<String, Object> result = Map.of(
                    ...
                    "hasMore", dtIter.hasNext(),
                    "totalDataTypeCount", dtm.getDataTypeCount(true)
                );
    ...
    private void collectCategories(Category category, List<Map<String, Object>> categories, int depth, int maxDepth) {
        if (depth > maxDepth) {
            return;
        }
        
        Map<String, Object> catInfo = Map.of(
            "name", category.getName(),
            "path", category.getCategoryPath().getPath(),
            "dataTypeCount", category.getDataTypes().length,
            "subcategoryCount", category.getCategories().length
        );
