...
/**
 * Base test class for testing Ghidra MCP tools. Provides common mocking setup and utilities for
 * testing tool execute methods.
 */
@ExtendWith(MockitoExtension.class)
public abstract class BaseToolTest {

  @Mock protected McpTransportContext mockContext;

  @Mock protected PluginTool mockTool;

  @Mock protected Project mockProject;

  @Mock protected ProjectData mockProjectData;

  @Mock protected ProjectManager mockProjectManager;

  @Mock protected Program mockProgram;

  @Mock protected FunctionManager mockFunctionManager;

  @Mock protected ghidra.program.model.data.ProgramBasedDataTypeManager mockDataTypeManager;

  @Mock protected Memory mockMemory;

  @Mock protected SymbolTable mockSymbolTable;

  @Mock protected AddressFactory mockAddressFactory;

  @Mock protected AddressSpace mockAddressSpace;

  @Mock protected Address mockAddress;

  @Mock protected DomainFile mockDomainFile;
  ...
  void setUpBaseMocks() {
    ...
    // Simulate open data containing our domain file (used by
    // IGhidraMcpSpecification.findDomainFile)
    ...
    try {
      when(mockDomainFile.getDomainObject(any(), anyBoolean(), anyBoolean(), any()))
  ...
  protected DataType createMockDataType(String name, String categoryPath) {
    ...
    // Mock category path
    ghidra.program.model.data.CategoryPath mockCategoryPath =
        org.mockito.Mockito.mock(ghidra.program.model.data.CategoryPath.class);
  ...
  protected void assertGhidraMcpException(
